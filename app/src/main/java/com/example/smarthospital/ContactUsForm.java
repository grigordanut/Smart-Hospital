...
public class ContactUsForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText usrSubject = findViewById(R.id.etSubjectContactUs);
        ...
        post_Message.setOnClickListener(v -> {
            ...
            String subject = usrSubject.getText().toString();
            ...
            if (TextUtils.isEmpty(name)){
                ...
                usrSubject.setError("Enter your Subject");
                usrSubject.requestFocus();
            }
